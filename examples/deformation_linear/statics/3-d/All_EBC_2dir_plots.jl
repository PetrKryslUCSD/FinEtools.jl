...
set(axis="loglog", plotstyle="linespoints", linewidth=2, pointsize = 2, xrange="[0.006:0.1]", xlabel = "Element size", ylabel = "Approximate error", grid="on", title = "")
...
# inputcsv = "All_EBC_2dir_H8_default_Stress.CSV"
# x = coldata(inputcsv, 1)
# y = coldata(inputcsv, 4)
# plot(x, abs.(y), legend = "H8", color = "black", marker = "x")

# inputcsv = "All_EBC_2dir_MSH8_extrapmean_Stress.CSV"
# x = coldata(inputcsv, 1)
# y = coldata(inputcsv, 4)
# plot!(x, abs.(y), legend="MSOE", color = "black", marker = "edmd")
...
# Wrote All_EBC_2dir_MSH8_extraptrend_Stress.CSV

# Displacement RMS error
# Normalized Approximate Error = [0.00947204, 0.00264193, 0.000695543]
# Linear log-log fit: p = [1.88373, 1.75715]
# Wrote All_EBC_2dir_MSH8_extraptrend_Displ.CSV
# Mesh: na, nb, nts = 3, 3, [3]
# count(fens) = 64
# Mesh: na, nb, nts = 6, 6, [6]
# count(fens) = 343
...
# Normalized Approximate Error = [0.0288266, 0.0128894, 0.00580383]
# Linear log-log fit: p = [1.15616, 0.384708]
# Wrote All_EBC_2dir_MSH8_default_Stress.CSV

# Displacement RMS error
# Normalized Approximate Error = [0.00947204, 0.00264193, 0.000695543]
# Linear log-log fit: p = [1.88373, 1.75715]
# Wrote All_EBC_2dir_MSH8_default_Displ.CSV
# Done
# #####################################################
