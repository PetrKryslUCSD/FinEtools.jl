...
module mmmmCookmmfakeorthommmm
using FinEtools
using FinEtools.AlgoDeforLinearModule
using FinEtools.MeshExportModule
using Base.Test
...
using mmmmCookmmfakeorthommmm
mmmmCookmmfakeorthommmm.test()

module mmmmmCanttronglymmmmm
using FinEtools
using FinEtools.AlgoDeforLinearModule
using Base.Test
function test()
...
using mmmmmCanttronglymmmmm
mmmmmCanttronglymmmmm.test()

module mmmmmmNAFEMS_R0031_3mmmm
using FinEtools
using FinEtools.AlgoDeforLinearModule
using Base.Test
function test()
...
using mmmmmmNAFEMS_R0031_3mmmm
mmmmmmNAFEMS_R0031_3mmmm.test()

module mmtwistedmsh8mmmmmm
using FinEtools
using FinEtools.AlgoDeforLinearModule
...
using mmmmmtwistedbeamisommmmm
mmmmmtwistedbeamisommmmm.test()

module mmmmmtwistedbeamoorthommmmm
using FinEtools
using Base.Test
using FinEtools.AlgoDeforLinearModule
function test()
...
using mmmmmtwistedbeamoorthommmmm
mmmmmtwistedbeamoorthommmmm.test()

module mmmmuunit_cube_modes_exportmmmmmm
using FinEtools
...
using mmmmLE11Q8aximmmmmm
mmmmLE11Q8aximmmmmm.test()


module mmmmLE11Q8aximorthom
using FinEtools
using Base.Test
function test()
  # NAFEMS LE11 benchmark with Q8 elements.
...
using mmmmLE11Q8aximorthom
mmmmLE11Q8aximorthom.test()
...
function test()
    ...
    *ELEMENT, TYPE=C3D10M, ELSET=EALL
    ...
    # println("Sigma_y =$(fld.values[nl,1][1]/phun("MPa")) as compared to reference sigma_yP = $(sigma_yP/phun("MPa")) [MPa]")
    @test abs(fld.values[nl,1][1]/phun("MPa") - -5.598421810873015) < 1.0e-3

    fld= fieldfromintegpoints(femm, geom, u, :Cauchy, 2; tonode = :estimtrendpaper)#
    # println("Sigma_y =$(fld.values[nl,1][1]/phun("MPa")) as compared to reference sigma_yP = $(sigma_yP/phun("MPa")) [MPa]")
    @test abs(fld.values[nl,1][1]/phun("MPa") - -5.613064468385159) < 1.0e-3
...
using mmmmmLE10expimpmmmmm
mmmmmLE10expimpmmmmm.test()

module mmmLE10expiAbaqus2mmmmmmm
using FinEtools
using FinEtools.MeshExportModule
using Base.Test
function test()
    ...
    @test abs(fld.values[nl,1][1]/phun("MPa") - -6.356261483059897) < 1.0e-3
...
using mmmLE10expiAbaqus2mmmmmmm
mmmLE10expiAbaqus2mmmmmmm.test()
