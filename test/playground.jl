...
function test()
    ...
    for Refinement = [1, 2, 4]
        ...
        for layer = 1:nLayers
            ...
            # File =  "Pagano_3layer_cylindrical_bending-r$(layer).vtk"
            # vtkexportmesh(File, connasarray(regions[layer]["femm"].integdata.fes), fens.xyz, FinEtools.MeshExportModule.H8)
        end
